...
# This is a math and binary game

# Importing all the functions and methods of the game
...
"""
    ...
    userChoice = 0
    # Asking user if they want to play the binary or math game
    while userChoice != "-1":
        ...
        # Asking user if they want to play again or leave the program
